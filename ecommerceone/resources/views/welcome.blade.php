  ...
  <div class="container" id="page-3">
    ...
    <div class="row">
      @foreach($read1 as $r)
        <div class="col">
          <div class="card" style="width: 100%;">
            <img src="{{$r->image}}" class="card-img-top" alt="..." style="max-width: 250px !important;
            max-height: 310px !important;">
            <div class="card-body">
              <h5 class="card-title">{{substr($r->name, 0, 10)}}</h5>
              ...
              <div class="row">
                <div class="col my-1">
                <form action="{{url('addcart',$r->id)}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <input type="number" value="1" min="1" class="form-control my-1" name='quantity'>
                    <input type="submit" class="btn btn-primary my-1 form-control " value="Add to cart">
    ...
    <div class="row">
      ...
      <div class="col">
        <div class="card" style="width: 100%;">
          <img src="{{$r->image}}" class="card-img-top" alt="..."tyle="max-width: 250px !important;
          max-height: 310px !important;">
          <div class="card-body">
            <h5 class="card-title">{{substr($r->name, 0, 10)}}</h5>
            <span class="fa fa-star checked"></span>
